...
<div class="container">
    ...
    <br>
    @endif
    <h2>File Upload & Image Preview {{$data}}</h2>
    <p class="lead">No Plugins <b>Just Javascript</b></p>
    <!-- Upload  -->
    <form id="file-upload-form" class="uploader" action="{{route('image.store', $data)}}" method="post" accept-charset="utf-8" enctype="multipart/form-data">
        @csrf
